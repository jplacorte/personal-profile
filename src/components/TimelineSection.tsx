...
const eras = [
  {
    ...
    story: "This is where my love for technology began! Between school projects and discovering my very first video games, I became completely fascinated by computers and how digital worlds worked. Sitting in computer shops, watching hardware operate, and typing commands created the spark. During these days, I watched shows like Pokémon, Slam Dunk, Yu-Gi-Oh!, Naruto, and Dragon Ball Z on TV. I also loved music and frequently tuned into the MYX channel to catch my favorite songs, including \"In the End\" by Linkin Park, \"Down\" by Jay Sean, \"One Time\" by Justin Bieber, \"Fireflies\" by Owl City, \"Because of You\" by Ne-Yo, \"With You\" by Chris Brown, \"Where Is the Love?\" by The Black Eyed Peas, and \"Thunder\" and \"Love Drunk\" by Boys Like Girls. I also played my first rich story games like Final Fantasy I, Final Fantasy Tactics: The War of the Lions, Star Ocean: First Departure, and God of War, as well as fighting games like Dissidia, Dissidia Duodecim, Tekken, and Naruto: Ultimate Ninja Heroes—all on a PSP console that my father bought for me. When I wasn't gaming, I also started playing basketball with my cousins.",
