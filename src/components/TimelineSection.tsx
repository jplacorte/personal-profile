...
const eras = [
  {
    ...
    story: "This is where my love for technology began! Between school projects and discovering my first video games, I became completely fascinated by computers and how digital worlds worked. Sitting in internet cafes, watching hardware operate, and typing commands created the spark. During these days, I watched shows like Pokémon, Slam Dunk, Yu-Gi-Oh!, Naruto, and Dragon Ball Z on TV. I also loved music and frequently tuned into the MYX channel to catch hits like \"In the End\" by Linkin Park, \"Down\" by Jay Sean, \"One Time\" by Justin Bieber, \"Fireflies\" by Owl City, \"Because of You\" by Ne-Yo, \"With You\" by Chris Brown, \"Where Is the Love?\" by The Black Eyed Peas, and \"Thunder\" and \"Love Drunk\" by Boys Like Girls. I played my first story-rich RPGs and action games—like Final Fantasy I, Final Fantasy Tactics: The War of the Lions, Star Ocean: First Departure, and God of War, as well as fighting games like Dissidia Final Fantasy, Tekken, and Naruto: Ultimate Ninja Heroes—all on the PSP console my father bought for me. When I wasn't gaming, I played basketball with my cousins.",
  ...
  },
  {
    ...
    story: "I studied at Dao Catholic High School Inc. for my high school years, which were all about diving deeper into the competitive gaming scene. I was hooked on League of Legends and always looked forward to going home to play right away. I also started watching anime series like Attack on Titan, Sword Art Online, and Haikyu!!. Outside of school and gaming, I was active in our local parish, serving as an altar server and singing in the church choir. I also joined the Senior Scouts, which allowed me to travel to different places for Scout Jamborees. Along the way, I began caring about frame rates, understanding PC components, and realizing that I was incredibly curious to learn how computers work, rather than just playing games on them.",
  ...
  },
  {
    ...
    story: "I attended Central Philippine University for college, formalizing my passion by diving headfirst into software development! I was just an average student who wanted to graduate on time, but college became a blur of learning programming languages, data structures, and architecting my first projects. Alongside formal classes, I did a lot of self-studying and learned to code from my talented classmates. With a limited allowance, I learned to budget my money and grew to enjoy traveling despite the long three-hour commute from my house to the city, which would sometimes extend by an extra 30 minutes. Consequently, I only went home during vacations or long weekends. Navigating those trips on my own turned these years into a journey of both personal independence and professional growth.",
      ...
      <div className="max-w-4xl mx-auto z-10 relative">
        ...
        <div className="mb-16 relative cute-timeline-stagger px-4">
          ...
          >
            ...
            {/* Active progress bar */}
            <div 
              className="cute-timeline-progress absolute left-0 top-0 h-full bg-cute-peach"
              style={{ width: "0%" }}
            />
          </div>
